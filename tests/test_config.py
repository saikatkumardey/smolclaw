...
def test_to_dict(tmp_path, monkeypatch):
    ...
    assert set(d.keys()) == {"model", "effort", "max_turns", "subagent_max_turns", "subagent_timeout", "btw_model", "subconscious_enabled", "subconscious_interval_hours", "subconscious_model"}
